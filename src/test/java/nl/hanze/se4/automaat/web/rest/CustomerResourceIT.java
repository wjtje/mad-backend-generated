...
class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().nr(DEFAULT_NR).lastName(DEFAULT_LAST_NAME).firstName(DEFAULT_FIRST_NAME).from(DEFAULT_FROM);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().nr(UPDATED_NR).lastName(UPDATED_LAST_NAME).firstName(UPDATED_FIRST_NAME).from(UPDATED_FROM);
        return customer;
    }
    ...
    void putExistingCustomer() throws Exception {
        ...
        Customer testCustomer = customerList.get(customerList.size() - 1);
        assertThat(testCustomer.getNr()).isEqualTo(UPDATED_NR);
