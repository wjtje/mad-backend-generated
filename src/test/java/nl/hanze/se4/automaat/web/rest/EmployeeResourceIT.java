...
class EmployeeResourceIT {
    ...
    public static Employee createEntity(EntityManager em) {
        Employee employee = new Employee().nr(DEFAULT_NR).lastName(DEFAULT_LAST_NAME).firstName(DEFAULT_FIRST_NAME).from(DEFAULT_FROM);
        return employee;
    }
    ...
    public static Employee createUpdatedEntity(EntityManager em) {
        Employee employee = new Employee().nr(UPDATED_NR).lastName(UPDATED_LAST_NAME).firstName(UPDATED_FIRST_NAME).from(UPDATED_FROM);
        return employee;
    }
    ...
    void putExistingEmployee() throws Exception {
        ...
        Employee testEmployee = employeeList.get(employeeList.size() - 1);
        assertThat(testEmployee.getNr()).isEqualTo(UPDATED_NR);
        assertThat(testEmployee.getLastName()).isEqualTo(UPDATED_LAST_NAME);
        assertThat(testEmployee.getFirstName()).isEqualTo(UPDATED_FIRST_NAME);
        assertThat(testEmployee.getFrom()).isEqualTo(UPDATED_FROM);
    }
